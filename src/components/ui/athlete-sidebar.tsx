...
export function AthleteSidebar({ onLogout, ...props }: React.ComponentProps<typeof Sidebar> & { onLogout?: () => void }) {
      ...
      <SidebarHeader className="h-20 flex justify-center border-b bg-card">
        <div className="flex items-center gap-3 px-2 group-data-[collapsible=icon]:justify-center">
          ...
          <div className="grid flex-1 text-left text-sm leading-tight group-data-[collapsible=icon]:hidden">
            ...
            <span className="truncate text-[10px] uppercase font-bold text-muted-foreground tracking-widest">Athlete Portal</span>
          </div>
        </div>
      </SidebarHeader>
