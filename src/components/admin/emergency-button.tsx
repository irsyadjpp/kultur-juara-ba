  ...
  return (
    <Dialog open={isOpen} onOpenChange={setIsOpen}>
      <DialogTrigger asChild>
        <Button 
            className="fixed bottom-6 right-6 w-14 h-14 rounded-full bg-red-600 hover:bg-red-700 shadow-[0_0_20px_rgba(220,38,38,0.7)] animate-pulse hover:animate-none z-50 flex items-center justify-center border-4 border-background"
            size="icon"
        >
            <AlertTriangle className="w-8 h-8 text-white" />
        </Button>
      </DialogTrigger>
      <DialogContent className="bg-card border-red-500/50 border-2 max-w-sm">
        <div className="text-center space-y-6 py-4">
            ...
            <div>
                ...
                <p className="text-muted-foreground text-sm">Pilih jenis bantuan yang dibutuhkan segera.</p>
            </div>
            
            <div className="grid grid-cols-2 gap-4">
                <Button 
                    variant="outline" 
                    className="h-24 flex flex-col gap-2 border-red-500/20 hover:bg-red-500/10 hover:text-red-500"
                ...
                <Button 
                    variant="outline" 
                    className="h-24 flex flex-col gap-2 border-orange-500/20 hover:bg-orange-500/10 hover:text-orange-500"
                ...
                >
                 ...
                 <Button 
                    variant="outline" 
                    className="col-span-2 h-16 flex items-center gap-2 hover:bg-secondary"
