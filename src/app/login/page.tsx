...
export default function UnifiedLoginPage() {
    ...
    const handleGoogleLogin = async () => {
        ...
        try {
            ...
            const userData = {
                email: user.email!,
                name: user.displayName || 'Pengguna Tanpa Nama',
                avatar: user.photoURL || '',
                uid: user.uid
            };

            const res = await unifiedGoogleLogin(userData);
            ...
            toast({ title: "Gagal Login", description: error.message || "Terjadi kesalahan saat login dengan Google.", variant: "destructive" });
        }
    };
