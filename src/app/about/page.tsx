      ...
      <main className="flex-grow pt-24 pb-20 relative overflow-hidden">
        ...
        <div className="container mx-auto px-4 mb-24 relative z-10 text-center">
          ...
          <p className="text-lg md:text-xl text-muted-foreground max-w-3xl mx-auto font-medium">
            Kultur Juara Indonesia adalah akademi bulutangkis yang berdedikasi untuk mencetak generasi atlet berkarakter, berprestasi, dan bermental juara.
          </p>
        </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
            <div className="relative h-[450px] rounded-[2.5rem] overflow-hidden bg-secondary border flex items-center justify-center p-8">
              ...
              <div className="relative z-10 text-center">
                ...
                <p className="text-3xl font-black text-foreground leading-tight">Kultur Juara Indonesia</p>
