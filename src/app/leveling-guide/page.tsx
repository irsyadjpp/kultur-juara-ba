...
export default function LevelingGuidePage() {
  return (
    <div className="flex flex-col min-h-screen bg-background pb-20 pt-24 relative overflow-hidden">
      ...
      <div className="container mx-auto px-4 mb-16 relative z-10 text-center">
         <Badge variant="outline" className="mb-4 px-4 py-1 border-primary text-primary font-bold tracking-widest uppercase">Official Guide</Badge>
      ...
      <div className="container mx-auto px-4 mb-20">
         <div className="bg-surface-variant/30 border border-white/5 rounded-[3rem] p-8 md:p-12 relative overflow-hidden">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-6">
               ...
               <Card className="bg-red-950/20 border-2 border-red-900/50 p-6 flex flex-col justify-center items-center text-center">
                  ...
                  <p className="font-bold text-white mb-2">Beginner + Advance</p>
      ...
      <div className="container mx-auto px-4">
         <div className="bg-zinc-900 text-zinc-100 rounded-[2.5rem] p-8 md:p-12 shadow-xl">
...
function MatrixCard({ title, color, children }: any) {
    ...
    return (
        <Card className={cn("border-2 rounded-[2rem] overflow-hidden", colors[color as keyof typeof colors])}>
            <div className="p-4 border-b border-black/5 dark:border-white/5 bg-black/5 dark:bg-white/5">
                <h4 className="font-bold text-center uppercase tracking-tight">{title}</h4>
            </div>
    ...
    return (
        <div className={cn(
            ...
            <div className="text-right">
                ...
                {note && <span className="block text-[8px] uppercase tracking-wider font-bold opacity-70">{note}</span>}
            </div>
        </div>
    )
}
