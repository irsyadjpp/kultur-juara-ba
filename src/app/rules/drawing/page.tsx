      ...
      <main className="flex-grow container mx-auto px-4 py-24">
        ...
        <div className="text-center mb-16">
            ...
            <p className="text-lg text-muted-foreground max-w-2xl mx-auto font-medium">
                Pahami mekanisme drawing dan prinsip penjadwalan untuk memastikan keadilan bagi semua.
            </p>
        </div>

        <Tabs defaultValue="drawing" className="w-full">
            <TabsList className="grid w-full grid-cols-2 max-w-lg mx-auto h-14 p-1 rounded-2xl">
                <TabsTrigger value="drawing" className="h-full rounded-xl text-base">Mekanisme Drawing</TabsTrigger>
                <TabsTrigger value="scheduling" className="h-full rounded-xl text-base">Prinsip Penjadwalan</TabsTrigger>
            </TabsList>
