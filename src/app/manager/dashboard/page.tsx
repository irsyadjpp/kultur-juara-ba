    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        ...
        <Card className="md:col-span-1 bg-gradient-sport text-white border-none shadow-m3-3 rounded-[2rem] overflow-hidden relative">
           ...
           <CardContent className="p-8 flex flex-col h-full justify-center relative z-10 text-center">
              <p className="text-white/80 font-medium mb-2 uppercase tracking-widest text-xs">Kode Klub</p>
              ...
              <p className="text-xs text-white/70 mb-6">
                 Bagikan kode ini kepada atlet Anda untuk bergabung otomatis ke dalam data klub.
              </p>
              <div className="bg-black/20 rounded-xl p-4 backdrop-blur-sm">
                 <div className="flex justify-between text-sm mb-1">
                    <span className="opacity-80">Total Atlet</span>
        ...
        <div className="md:col-span-2 grid grid-cols-2 gap-4">
           {[
             { label: "Siap Latih", val: 30, total: 42, color: "bg-blue-500", icon: UserCheck, desc: "Selesai verifikasi dokumen" },
             { label: "Menunggu Pembayaran", val: 12, total: 42, color: "bg-orange-500", icon: Users, desc: "Menunggu pembayaran iuran" },
             { label: "Pembayaran Lunas", val: 8, total: 42, color: "bg-green-500", icon: Trophy, desc: "Pembayaran bulan ini lunas" },
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
         ...
         <Card className="lg:col-span-2 rounded-[2rem] shadow-m3-1 border-none">
            <CardHeader>
               <CardTitle className="font-headline text-lg">NOTIFIKASI KLUB</CardTitle>
            </CardHeader>
            <CardContent className="space-y-4">
               <div className="bg-yellow-50 dark:bg-yellow-900/10 p-4 rounded-2xl flex gap-3 border border-yellow-100 dark:border-yellow-900/30">
                  ...
                  <div>
                     <h4 className="font-bold text-sm text-yellow-800 dark:text-yellow-500">Iuran Bulanan Segera Jatuh Tempo</h4>
                     <p className="text-xs text-yellow-700 dark:text-yellow-600 mt-1">
                        Segera selesaikan pembayaran untuk 12 atlet yang masih pending sebelum akhir bulan.
                     </p>
                  </div>
               ...
               <div className="flex items-center justify-between p-3 hover:bg-secondary/50 rounded-xl transition-colors">
                  <div className="flex items-center gap-3">
                     ...
                     <div>
                        <p className="text-sm font-bold">Revisi Dokumen Diperlukan</p>
                        <p className="text-xs text-muted-foreground">Akta lahir "Kevin" tidak terbaca.</p>
                     </div>
                  </div>
