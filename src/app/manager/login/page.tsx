      ...
      <div className="w-full lg:w-[40%] flex items-center justify-center p-8 relative">
         ...
         <div className="w-full max-w-md space-y-8 relative z-10">
            ...
            <div className="space-y-4">
                ...
                <Link href="/manager/dashboard" className="group relative w-full h-14 bg-white text-black font-bold rounded-xl flex items-center justify-center gap-3 transition-all hover:scale-[1.02] active:scale-[0.98]">
                    {/* Icon Google SVG */}
