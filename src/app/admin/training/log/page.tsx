      ...
      <form className="space-y-8">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
            <SectionCard title="Catatan Pelatih" icon={StickyNote}>
                <Textarea placeholder="Observasi, feedback, atau rencana untuk sesi berikutnya..." className="bg-zinc-950 border-zinc-800 rounded-xl h-32"/>
            </SectionCard>
            <SectionCard title="Catatan Atlet" icon={User}>
                <Textarea placeholder="Bagaimana perasaan Anda hari ini? Apa yang dirasakan selama latihan? (Self-report)" className="bg-zinc-950 border-zinc-800 rounded-xl h-32"/>
            </SectionCard>
        </div>
