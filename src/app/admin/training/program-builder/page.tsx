...
import { 
  FileSignature, Save, Calendar, Clock, Target, Dumbbell, BrainCircuit, Heart, BarChart, FileText
} from "lucide-react";
  ...
  return (
    <div className="space-y-8 p-4 md:p-0">
      ...
      <form className="space-y-8">
        ...
        {/* FORM 1: IDENTITAS PROGRAM */}
        <SectionCard title="1. Identitas Program" icon={FileSignature}>
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                <div className="space-y-2">
                    <Label>Nama PB</Label>
                    <Input defaultValue="Kultur Juara PWN" className="h-12 rounded-xl bg-secondary border"/>
                </div>
                <div className="space-y-2">
                    <Label>Kelompok Usia</Label>
                    <Select><SelectTrigger className="h-12 rounded-xl bg-secondary border"><SelectValue placeholder="Pilih Usia..." /></SelectTrigger><SelectContent><SelectItem value="U13">U-13</SelectItem><SelectItem value="U15">U-15</SelectItem><SelectItem value="U17">U-17</SelectItem></SelectContent></Select>
                </div>
                <div className="space-y-2">
                    <Label>Level Atlet</Label>
                    <Select><SelectTrigger className="h-12 rounded-xl bg-secondary border"><SelectValue placeholder="Pilih Level..." /></SelectTrigger><SelectContent><SelectItem value="pemula">Pemula</SelectItem><SelectItem value="pratanding">Pratanding</SelectItem><SelectItem value="prestasi">Prestasi</SelectItem></SelectContent></Select>
                </div>
                <div className="space-y-2">
                    <Label>Periode Program</Label>
                    <Input type="month" placeholder="Bulan / Tahun" className="h-12 rounded-xl bg-secondary border"/>
                </div>
                <div className="space-y-2">
                    <Label>Fase Periodisasi</Label>
                    <Select><SelectTrigger className="h-12 rounded-xl bg-secondary border"><SelectValue placeholder="Pilih Fase..." /></SelectTrigger><SelectContent>
                ...
                <div className="space-y-2">
                    ...
                    <Input placeholder="Nama Pelatih" className="h-12 rounded-xl bg-secondary border"/>
                </div>
            </div>
        </SectionCard>

        {/* FORM 2: TUJUAN PROGRAM */}
        ...
        <div className="flex justify-end pt-6 border-t border-border">
            <Button size="lg" className="h-16 rounded-full font-bold text-lg px-10 shadow-lg shadow-primary/20">
                <Save className="w-6 h-6 mr-3"/> Simpan Program Latihan
            </Button>
        </div>
