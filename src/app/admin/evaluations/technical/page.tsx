...
const StatInput = ({ label, unit }: { label: string, unit: string }) => (
  <div className="space-y-2">
    ...
    <div className="flex items-center gap-2">
      <Input type="number" className="h-12 rounded-xl bg-zinc-950 border-zinc-800 font-mono" />
    ...
    <div className="space-y-8 p-4 md:p-0">
      ...
      <form className="space-y-8">
        ...
        <SectionCard title="Kesimpulan & Analisis" icon={Target}>
            <Textarea placeholder="Analisa kekuatan dan kelemahan utama. Tentukan fokus latihan teknis untuk siklus berikutnya..." className="bg-zinc-950 border-zinc-800 rounded-xl h-32"/>
        </SectionCard>
