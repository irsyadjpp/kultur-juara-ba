...
export default function ManagerLayout({ children }: { children: React.ReactNode }) {
  ...
  const menuGroups = [
    ...
    },
    {
        title: "MANAJEMEN TIM",
        items: [
            { name: "Registrasi Tim", href: "/admin/manager/register-team", icon: Users },
            { name: "Status & Verifikasi", href: "/admin/manager/status", icon: CheckCircle },
        ]
    },
    {
        title: "OPERASIONAL PERTANDINGAN",
        items: [
            { name: "Ajukan Protes", href: "/admin/manager/protest/submit", icon: AlertCircle },
            { name: "Tagihan & Denda", href: "/admin/manager/billing", icon: CreditCard },
        ]
    },
    {
        title: "AKUN & BANTUAN",
        items: [
            { name: "Dokumen & Unduh", href: "/admin/manager/downloads", icon: Download },
            { name: "Pengaturan Akun", href: "/admin/manager/settings", icon: Settings },
        ]
    }
  ];
